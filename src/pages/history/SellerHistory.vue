    ...
    <div class="w-full mt-6 ml-2">
        ...
        <div class="flex flex-col">
            <div class="pb-8 flex justify-between items-center">
                ...
                <el-button color="#626aef" style="font-size: medium;" round size="large" @click="createAuction">Create Auction</el-button>
            </div>
            <div v-if="listSellerHistorys.length" class="w-full flex flex-col items-center justify-center">
                <div v-for="item in listSellerHistorys" :key="item.id" class="w-full flex items-center justify-center mb-12">
